...
func (s *Service) BookSeats(ctx context.Context, movieID string, userID string, seatIDs []string) (Booking, error) {
	return s.store.BookMany(ctx, movieID, userID, seatIDs)
}
